...
class _LocationCelebrateViewState extends State<LocationCelebrateView> {
  final html.IFrameElement _iframeGroomElement = html.IFrameElement();
  final html.IFrameElement _iframeBrideElement = html.IFrameElement();

  @override
  void initState() {
    super.initState();
    if (kIsWeb) {
      _iframeGroomElement.src =
      ...
      _iframeGroomElement.style.border = 'none';
      ui.platformViewRegistry.registerViewFactory(
        'iframe-groom-view',
        (int viewId) => _iframeGroomElement,
      );

      _iframeBrideElement.src =
      'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5522.145939518608!2d105.82182694758983!3d21.199693200566415!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313503005e03b405%3A0xcb2924ca977c1e9d!2zTmjDoCB2xINuIGjDs2EgdGjDtG4gMjU!5e0!3m2!1sen!2s!4v1773497798162!5m2!1sen!2s" width="800" height="230" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade'; // URL to load
      _iframeBrideElement.style.border = 'none';
      ui.platformViewRegistry.registerViewFactory(
        'iframe-bride-view',
            (int viewId) => _iframeBrideElement,
      );
    }
  }
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: SizedBox(
                    width: 800,
                    height: 230,
                    child: HtmlElementView(viewType: 'iframe-groom-view'),
                  ),
                ),
            ...
            child: Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text("𓇼 ⋆.˚ 𓆉 𓆝 𓆡⋆.˚ 𓇼", style: TextStyle(color: AppColors.line)),
                ),
                Container(width: 120, height: 1, color: AppColors.line),
              ],
            ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Container(
                  constraints: BoxConstraints(maxWidth: 500),
                  child: Image.asset(AppAssets.culturalCenter),
                ),
                const SizedBox(height: 8),
                Text(
                  'Nhà văn hoá thôn 25',
                ...
                Text("Khu tập thể Z125, Mai Đình, Sóc Sơn"),
                Padding(
                  padding: const EdgeInsets.only(top: 8, bottom: 20),
                  child: Text(
                    "Hà Nội - Việt Nam",
                ...
                ClipRRect(
                  ...
                  child: SizedBox(
                    width: 800,
                    height: 230,
                    child: HtmlElementView(viewType: 'iframe-bride-view'),
                  ),
                ),
                const SizedBox(height: 12),
                InkWell(
                  onTap: () async {
                    await launchUrl(
                      Uri.parse('https://maps.app.goo.gl/Z2zy7bGHgT2ocDAb8'),
                    );
                  },
                  child: Column(
                    mainAxisSize: .min,
